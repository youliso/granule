import type { JSX, Component } from "../types";
import { h } from "./h";
...
class GlobalComponent {
  ...
  static getInstance() {
    if (!GlobalComponent.instance)
      GlobalComponent.instance = new GlobalComponent();
...
export const globalComponent = GlobalComponent.getInstance();
